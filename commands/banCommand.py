...
class ban(commands.Cog):
    ...
    async def ban(self, ctx, user_id, delete_message_days: int = 0, *, reason = None):
        ...
        if user == ctx.author:
            ...
            await ctx.guild.ban(user, reason = reason, delete_message_seconds = delete_message_days * 86400) 
